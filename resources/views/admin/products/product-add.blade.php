    ...
    <form action="{{ route('productAdd') }}" method="post" enctype="multipart/form-data"
        ...
        <div class="mb-4">
            ...
            <input
                ...
                type="text" placeholder="Masukan nama produk..." name="name" />
            @error('name')
        ...
        <div class="mb-4">
            ...
            <textarea id="message" rows="4"
                ...
                placeholder="Masukan deskripsi..." name="description"></textarea>
            @error('description')
                <div class="text-red-500">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-4">
            ...
            <input
                ...
                type="number" placeholder="Masukan harga..." name="price" />
            @error('price')
                <div class="text-red-500">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-4">
            ...
            <input
                ...
                type="number" placeholder="Masukan stok..." name="stock" />
            @error('stock')
                <div class="text-red-500">{{ $message }}</div>
            @enderror
        </div>
